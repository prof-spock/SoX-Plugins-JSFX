<TABLE CELLSPACING="0" CELLPADDING="0">
  <TR>
    <TH>
      <H1>JSFX SoX Plugins for DAWs</H1>
    <TH>
      <IMG SRC="./doc/figures/SoX-A-title.png" STYLE="float:right"
           WIDTH="55%" HEIGHT="55%">
    </TH>
  </TR>
</TABLE>
...
The JSFX SoX Plugins software package provides plugins for being used in
digital audio workstations (DAW); they implement some of the audio
processing effects from SoX.  It is also possible to
use them in any VST compatible DAW using the freely available [ReaJS
VST plugin][reference:reaJS] that is able to interpret JSFX files.
...
JSFX of the SoX algorithms for producing
...
![Panel for SoXPlugins Phaser](./doc/figures/SoX-J-Eff_Phaser.png)
...
![Example Noise Floor for Regression Test](./doc/figures/SoX-A-noiseFloor.png)
